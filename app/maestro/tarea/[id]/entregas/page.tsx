...
export default function EntregasTarea() {
  ...
  const promedio = entregas.filter(e => e.calificacion !== null).reduce((sum, e) => sum + (e.calificacion || 0), 0) / (entregas.filter(e => e.calificacion !== null).length || 1)
          ...
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
              ...
              <div className="text-center p-4 bg-blue-50 rounded-lg">
                <div className="text-2xl font-bold text-blue-600">{promedio.toFixed(1)}</div>
